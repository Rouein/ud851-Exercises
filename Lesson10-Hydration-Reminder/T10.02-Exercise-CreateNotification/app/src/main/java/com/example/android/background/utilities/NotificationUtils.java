...
public class NotificationUtils {
    ...
    private static final int WATER_REMINDER_PENDING_INTENT_ID = 2554;
    private static final int WATER_REMINDER_NOTIFICATION_ID = 2664;
    ...
    private static Bitmap nIcon(Context context) {
    ...
    // resources object and R.drawable.ic_local_drink_black_24px
        Bitmap nIcon = BitmapFactory.decodeResource(resources, R.drawable.ic_local_drink_black_24px);
        return nIcon;
    }
}
